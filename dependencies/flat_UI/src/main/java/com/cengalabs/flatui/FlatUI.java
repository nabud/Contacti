...
public class FlatUI {
    ...
    // EditText styles
    public static final int EDITTEXT_FLAT = 0;
    public static final int EDITTEXT_BOX = 1;
    public static final int EDITTEXT_TRANSPARENT = 2;

    //Custom Flat theme colors
    public static int[] myColors = new int[4];
    ...
    public static void setEditTextStyle(int style){
        FlatEditText.setStyle(style);
        FlatAutoCompleteTextView.setStyle(style);
    }

    public static void setUseFlatTextColor(boolean useFlatTextColor){
        FlatEditText.setUseFlatTextColor(useFlatTextColor);
        FlatTextView.setUseFlatTextColor(useFlatTextColor);
        FlatRadioButton.setUseFlatTextColor(useFlatTextColor);
        FlatCheckBox.setUseFlatTextColor(useFlatTextColor);
    }
}