...
public class FlatCheckBox extends CheckBox implements Attributes.AttributeChangeListener {
    ...
    public static void setUseFlatTextColor(boolean useFlatTextColor) {
        FlatCheckBox.useFlatTextColor = useFlatTextColor;
    }

    public static void setColor(int color){
        FlatCheckBox.color = color;
    }
    ...
    private void init(AttributeSet attrs) {
        if (!isInEditMode()) {
            ...
            if (attrs != null) {
                ...
                attributes.setSize(a.getDimensionPixelSize(R.styleable.fl_FlatCheckBox_fl_size, Attributes.RADIO_AND_CHECK_BUTTON_SIZE_PX));
