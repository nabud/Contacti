...
public class FlatRadioButton extends RadioButton implements Attributes.AttributeChangeListener {
    ...
    public static void setUseFlatTextColor(boolean useFlatTextColor) {
        FlatRadioButton.useFlatTextColor = useFlatTextColor;
    }

    public static void setColor(int color){
        FlatRadioButton.color = color;
    }
    ...
    private void init(AttributeSet attrs) {
        if (!isInEditMode()) {
            ...
            if (attrs != null) {
                ...
                attributes.setSize(a.getDimensionPixelSize(R.styleable.fl_FlatRadioButton_fl_size, Attributes.RADIO_AND_CHECK_BUTTON_SIZE_PX));
