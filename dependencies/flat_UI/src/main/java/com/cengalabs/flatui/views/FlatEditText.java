...
public class FlatEditText extends EditText implements Attributes.AttributeChangeListener {
    ...
    private static boolean useFlatTextColor = true;
    ...
    public static void setUseFlatTextColor(boolean useFlatTextColor) {
        FlatEditText.useFlatTextColor = useFlatTextColor;
    }

    public static void setColor(int color){
        FlatEditText.color = color;
    }
    ...
    private void init(AttributeSet attrs) {
        if (!isInEditMode()) {
            ...
            if (attrs != null) {
                ...
                //useFlatTextColor = attrs.getAttributeValue(FlatUI.androidStyleNameSpace, "textColor") != null;
                ...
                style = a.getInt(R.styleable.fl_FlatEditText_fl_fieldStyle, style);
            ...
            if (useFlatTextColor) setHintTextColor(attributes.getColor(3));
